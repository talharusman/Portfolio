...
function Contact() {
    ...
    const handleSubmit = async (e)=>{
        ...
        if (method === "whatsapp") {
            ...
            try {
                const result = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$emailjs$2f$browser$2f$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].send(("TURBOPACK compile-time value", "service_988k3se"), ("TURBOPACK compile-time value", "template_paxq1nh"), {
                    from_name: name,
                    from_email: email,
                    message: message
...
_s(Contact, "ZJiC2rP7sAJ79wyUsNStdufRUeA=");
_c = Contact;
var _c;
